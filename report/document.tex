...
\begin{document}
	...
	\begin{theorem}\label{th: in_eqpoint}
	...
	% сюда про внутреннее ПР
	
	\subsection{Математическое моделирование}
	
	\begin{example}
		Рассмотрим систему \ref{eq:initial_system} при значениях параметров, данных в~\cite{model_params}. Т.к. в источнике указан только диапазон значений параметра $a_2$, положим, что $a_2=0.25$. Тогда, согласно теореме \refth{th:in_eqpoint} система имеет граничные положения равновесия
	...
	% другой пример --- подобрать параметры такие, что 
