...
\begin{document}
	...
	\begin{proof}
		...
		Покажем, что множество $K_5$ содержит аттрактор системы. Решение автономной системы дифференциальных уравнений $\dot{x}=F(x)$, где $F(x)$ --- гладкое векторное поле, с начальным значением из любого компакта продолжается вперед неограниченно, либо до границы этого компакта\cite[с.~84]{Arnold}. Для любой траектории системы \ref{eq:initial_system} существует такой набор $\tau_i$, что ее начальная точка будет содержаться в множестве $K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5)$. Вследствие положительной инвариантности данного компакта а также того, что $\dot{\phi}_i(x)<0$ при положительных значениях $\tau_iр$ имеем, что траектории, начинающиеся вне $K_5$, не будут его покидать и не будут достигать границ компактов $K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5)$, содержащих их начальные, т.е. они ограничены и могут быть неограниченно продолжены. В таком случае, предельные множества всех траекторий из области $D$ содержатся в компактах $K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5)$ и т.к.
		\[K_5=\mathop{\cap}\limits_{\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5 \geqslant 0}K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5),\]
		можно сделать вделать вывод о том, что $K_5$ --- положительно инвариантный компакт, содержащий аттрактор системы.\qed
	\end{proof}	
	...
	\begin{example}
		...
		\begin{figure}[h]
			...
			\caption{Переходные процессы системы для троек координат}
			\label{fig:in_D_3d}
		\end{figure}
		...
		\begin{figure}[h]
			...
			\caption{Переходные процессы системы при выборе начальной точки на на плоскости $x_1=x_3=x_5=0$}
