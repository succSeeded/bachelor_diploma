...
\begin{document}
	...
	\addcontentsline{toc}{section}{\MakeUppercase{Аннотация}}
	...
	\begin{proof}
		...
		\begin{equation*}
			...
			\end{cases}
		\end{equation*} 
		Следовательно, из единственности решения имеем, что
		\[x_1\equiv0,\, x_2=x_2(t),\, x_3=x_3(t),\, x_4=x_4(t),\, x_5=x_5(t),\, t\in[0,\,\varepsilon_1),\]
		является решением исходной системы с начальными условиями \ref{eq:conds_1}, лежащим на плоскости $x_1=0$ и не покидающим области $D$.
		
		Рассмотрим случай, когда
		\begin{equation}\label{eq:conds_2}
			x_1(0)\ge0,\, x_2(0)=0,\, x_3(0)\ge0,\, x_4(0)\ge0,\, x_5(0)\ge0.
		\end{equation}
		Для каждого такого начального условия также существует $\varepsilon_2>0$ такое, что существует единственное решение задачи Коши на полуинтервале $t\in[0,\,\varepsilon_2)$ обращающее систему \ref{eq:initial_system} в тождество. Заметим, что в случае если $x_2(t)\equiv0$, \ref{eq:initial_system} преобразуется к следующему виду:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{\alpha_2x_3}{x_4+e_1}\dfrac{x_1}{x_1+k_1},\\
					0 &= \dfrac{x_5}{k_4+x_5}a_1\dfrac{1}{x_4+e_2},\\
					\dot{x}_3 &= a_2\dfrac{x_1}{k_5+x_4}-\mu_1x_3-\alpha_4\dfrac{x_1}{x_1+k_3}x_3,\\
					\dot{x}_4 &= s_1 + b_1x_1-\mu_2x_4,\\
					\dot{x}_5 &= b_2x_3-\mu_3x_5,
				\end{aligned}
			\end{cases}
		\end{equation*} 
		Таким образом, $x_2(t)\equiv0$ может быть решением \ref{eq:initial_system} в случае если $x_5(t)\equiv0$. Тогда получим, что:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{\alpha_2x_3}{x_4+e_1}\dfrac{x_1}{x_1+k_1},\\
			...
			\end{cases}
		\end{equation*}  
		т.е. $x_5(t)\equiv0$ только тогда, когда $x_3(t)\equiv0$. В таком случае
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{\alpha_2x_3}{x_4+e_1}\dfrac{x_1}{x_1+k_1},\\
					0 &= a_2\dfrac{x_1}{k_5+x_4},\\
					\dot{x}_4 &= s_1 + b_1x_1-\mu_2x_4,\\
				\end{aligned}
			\end{cases}
		\end{equation*} 
		из чего $x_3(t)\equiv0$ тогда и только тогда, когда $x_1(t)\equiv0$. Тогда система примет следующий вид:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
		...
		\[x_1\equiv0,\, x_2\equiv0,\, x_3\equiv0,\, x_4=x_4(t),\, x_5\equiv0,\, t\in[0,\,\varepsilon_2),\]
		является решением исходной системы с начальными условиями \ref{eq:conds_2}, лежащим на плоскости $x_2=0$ и не покидающим области $D$.
		
		Рассмотрим случай, когда
		\begin{equation}\label{eq:conds_3}
			x_1(0)\ge0,\, x_2(0)\ge0,\, x_3(0)=0,\, x_4(0)\ge0,\, x_5(0)\ge0.
		\end{equation}
		Для каждого такого начального условия имеется $\varepsilon_3>0$ такое, что существует единственное решение задачи Коши на $t\in[0,\varepsilon_3)$ обращающее систему \ref{eq:initial_system} в тождество. Заметим, что в случае если $x_3(t)\equiv0$, исходная система преобразуется к следующему виду:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{\alpha_1x_2}{x_4+e_1}\dfrac{x_1}{x_1+k_1},\\
					\dot{x}_2 &= r_2x_2\left(1-\dfrac{x_2}{c_2}\right)+\dfrac{x_5}{k_4+x_5}a_1\dfrac{1}{x_4+e_2}-\alpha_3\dfrac{x_1}{x_1+k_2}x_2,\\
					0 &= a_2\dfrac{x_1}{k_5+x_4},\\
					\dot{x}_4 &= s_1 + b_1x_1-\mu_2x_4,\\
					\dot{x}_5 &= -\mu_3x_5,
		...
		является решением исходной системы с начальными условиями \ref{eq:conds_3}, лежащим на плоскости $x_3=0$ и не покидающим области $D$.
		
		В случае если 
		\begin{equation}\label{eq:conds_4}
			x_1(0)\ge0,\, x_2(0)\ge0,\, x_3(0)\ge0,\, x_4(0)\ge0,\, x_5(0)=0.
		\end{equation}
		Для каждого такого начального условия существует $\varepsilon_4>0$ такое, что существует единственное решение задачи Коши при $t\in[0,\varepsilon_4)$ обращающее систему \ref{eq:initial_system} в тождество. В случае если $x_5(t)\equiv0$, \ref{eq:initial_system} преобразуется к следующему виду:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
				\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{1}{x_4+e_1}(\alpha_1x_2+\alpha_2x_3)\dfrac{x_1}{x_1+k_1},\\
				\dot{x}_2 &= r_2x_2\left(1-\dfrac{x_2}{c_2}\right)-\alpha_3\dfrac{x_1}{x_1+k_2}x_2,\\
				\dot{x}_3 &= a_2\dfrac{x_1}{k_5+x_4}-\mu_1x_3-\alpha_4\dfrac{x_1}{x_1+k_3}x_3,\\
				\dot{x}_4 &= s_1 + b_1x_1-\mu_2x_4,\\
				0 &= b_2x_3.
				\end{aligned}
			\end{cases}
		\end{equation*}
		Данная система обращается в тождество только тогда, когда $x_3(t)\equiv0$:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1 &= r_1x_1\left(1-\dfrac{x_1}{c_1}\right)-\dfrac{\alpha_1x_2}{x_4+e_1}\dfrac{x_1}{x_1+k_1},\\
			...
			\end{cases}
		\end{equation*}
		что справедливо только при $x_1(t)\equiv0$. В таком случае\\
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
		...
		является решением исходной системы с начальными условиями \ref{eq:conds_4}, лежащим на плоскости $x_5=0$ и не покидающим области $D$.
		
		Для каждого из начальных условий вида
		\begin{equation*}
			x_1(0)\ge0,\, x_2(0)\ge0,\, x_3(0)\ge0,\, x_4(0)=0,\, x_5(0)\ge0,
		\end{equation*}
		имеется некое $\varepsilon_5>0$ такое, что существует единственное решение задачи Коши на полуинтервале $t\in[0,\epsilon_5)$, обращающее систему \ref{eq:initial_system} в тождество. В этом случае 
		\[\dot{x}_4(0)=s_1+b_1x_1(0)>0,\]
		т.е. 
		\[x_4(t)>0,\, t\in(0,\, \tilde{\varepsilon}_5),\,\tilde{\varepsilon}_5\le\varepsilon_5\]
		и траектория не выходит из $D$.
	\end{proof}
	...
	\begin{proof}
		...
		Действительно, варьируя $\tau_i$ можно добиться того, что любая точка $x\in D$ будет содержаться в неком множестве $K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5)$. Вследствие положительной инвариантности данного множества имеем, что траектории, начинающиеся внутри него, не будут его покидать.
	\end{proof}		
	...
	\begin{theorem}
		Система \ref{eq:initial_system} на границе области $D$ при положительных значениях параметров имеет положения равновесия $P_1\left(0,0,0,\frac{s_1}{\mu_1},0\right)$ и $P_2\left(0,c_2,0,\frac{s_1}{\mu_1},0\right)$. 
	\end{theorem}
