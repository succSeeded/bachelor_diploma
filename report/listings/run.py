...
model_params = {'r_1': .01, 'c_1': 8.8265e+5, 'e_1': 1e+4, 'alpha_1': 1.5, 'alpha_2': .12, 'k_1': 2.7e+4, 'r_2': .3307, 'c_2': 1e+6, 'a_1': .1163, 'k_4': 1.05e+4, 'e_2': 1e+4, 'alpha_3': .0194, 'k_2': 2.7e+4, 'a_2': .25, 'k_5': 2e+3, 'mu_1': .007, 'alpha_4': .1694, 'k_3': 3.3445e+5, 's_1': 6.3305e+4, 'b_1': 5.75e-6, 'mu_2': 6.93, 'b_2': 1.02e-4, 'mu_3': .102};
...
bounds = np.array([[0.0, model.Ox1], [0.0, model.Ox2], [0.0, model.Ox3], [model.Ux4, model.Ox4], [0.0, model.Ox5]]);
