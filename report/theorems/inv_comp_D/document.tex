...
%			\end{cases}
%		\end{equation*}
%		В случае если $x_3(0)>0$ получим, что $\dot{x}_5(0)>0$, из чего $x_5(t)>0,\, t\in(0,\, \tilde{\varepsilon}_4),\,\tilde{\varepsilon}_4\le\varepsilon_4$ и траектория не выходит из $D$ через плоскость $x_5=0$. Иначе при $x_3(0)=0$ система при $t=0$ преобразуется к следующему виду:
%		\begin{equation*}
%			\begin{cases}
%				\begin{aligned}
%					\dot{x}_1(0) &= r_1x_1(0)\left(1-\dfrac{x_1(0)}{c_1}\right)-\dfrac{\alpha_1x_2(0)}{x_4(0)+e_1}\dfrac{x_1(0)}{x_1(0)+k_1},\\
...
%		является решением исходной системы с начальными условиями \ref{eq:conds_5}, лежащим на плоскости $x_2=0$ и не покидающим области $D$.
	\end{proof}
\end{document}