...
\begin{document}
	...
	x_1(0)\geqslant0,\,x_2(0)\geqslant0,\,x_3(0)\geqslant0,\,x_4(0)\geqslant0,\,x_5(0)\geqslant0.
	\end{equation}
	
	Введем следующие обозначения:
	\[\mathbb{R}^n_{+,0}=\left\{x=(x_1,\dots,x_n)\in\mathbb{R}^n:\, x_i\geqslant0,\, i=\overline{1,n}\right\},\,\mathbb{R}_{+,0}=\left\{x\in\mathbb{R}:\, x\geqslant0\right\}.\]
	
	Для системы \ref{eq:initial_system} покажем, что множество $D=\mathbb{R}^{5}_{+,0} = \{x \geqslant 0\}$ положительно инвариантно, проведем исследование инвариантности пересечений множества $D$ с координатными плоскостями, а также систем, являющихся ограничениями \ref{eq:initial_system} на инвариантные координатные плоскости. Кроме того, найдем компактное множество, содержащее аттрактор системы.\pagebreak
	...
	\begin{theorem}\textbf{(Коши)}
		...
		\[\dot{x}=f(x,t),\, x(t_0)=x_0\in G,\, t\geqslant t_0,\]
	...
	\begin{theorem}
		Множество $D=\mathbb{R}^5_{+,0}$ является положительно инвариантным относительно системы \ref{eq:initial_system}.
	\end{theorem}
	\begin{proof}
		...
		\[x_i(t)\geqslant0,\, i=\overline{1,5},\, t\in[0,\,\varepsilon),\,\varepsilon>0.\]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{equation}\label{eq:conds_1}
			x_1(0)=0,\, x_2(0)\geqslant0,\, x_3(0)\geqslant0,\, x_4(0)\geqslant0,\, x_5(0)\geqslant0.
		\end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{equation*}
			x_1(0)\geqslant0,\, x_2(0)\geqslant0,\, x_3(0)\geqslant0,\, x_4(0)=0,\, x_5(0)\geqslant0,
		\end{equation*}
		...
		т.е. 
		\[x_4(t)>0,\, t\in(0,\, \tilde{\varepsilon}_2),\,\tilde{\varepsilon}_2\leqslant\varepsilon_2\]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{equation}\label{eq:conds_3}
			x_1(0)\geqslant0,\, x_2(0)\geqslant0,\, x_3(0)=0,\, x_4(0)\geqslant0,\, x_5(0)\geqslant0.
		\end{equation}
		...
		\begin{equation*}
			...
			\end{cases}
		\end{equation*}
		Если $x_1(0)>0$, то и $\dot{x}_3(0)>0$, из чего $x_1(t)>0,\, t\in(0,\, \tilde{\varepsilon}_3),\,\tilde{\varepsilon}_3\leqslant\varepsilon_3$ и траектория не выходит из $D$ через плоскость $x_3=0$. Если же $x_1(0)=0$, то при $t=0$ система примет вид:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1(0) &= 0,\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{equation}\label{eq:conds_4}
			x_1(0)\geqslant0,\, x_2(0)\geqslant0,\, x_3(0)\geqslant0,\, x_4(0)\geqslant0,\, x_5(0)=0.
		\end{equation}
		...
		\begin{equation*}
			...
			\end{cases}
		\end{equation*}
		В случае если $x_3(0)>0$ получим, что $\dot{x}_5(0)>0$, из чего $x_5(t)>0,\, t\in(0,\, \tilde{\varepsilon}_4),\,\tilde{\varepsilon}_4\leqslant\varepsilon_4$ и траектория не выходит из $D$ через плоскость $x_5=0$. При $x_3(0)=0$, в свою очередь, система в начальный момент преобразуется к следующему виду:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1(0) &= r_1x_1(0)\left(1-\dfrac{x_1(0)}{c_1}\right)-\dfrac{\alpha_1x_2(0)}{x_4(0)+e_1}\dfrac{x_1(0)}{x_1(0)+k_1},\\
			...
			\end{cases}
		\end{equation*} 
		Здесь при $x_1(0)>0$ имеем, что $\dot{x}_3(0)>0$, то есть $x_3(t)>0,\, t\in(0,\, \tilde{\varepsilon}^\prime_4),\,\tilde{\varepsilon}^\prime_4\leqslant\varepsilon_4$. Из этого следует, что $x_5(t)>0,\, t\in(0,\, \tilde{\varepsilon}^\prime_4),\,\tilde{\varepsilon}^\prime_4\leqslant\varepsilon_4$ и траектория не выходит из $D$ через плоскость $x_5=0$. При $x_1(0)=0$ система в начальный момент примет следующий вид:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1(0) &= 0,\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{equation}\label{eq:conds_5}
			x_1(0)\geqslant0,\, x_2(0)=0,\, x_3(0)\geqslant0,\, x_4(0)\geqslant0,\, x_5(0)\geqslant0.
		\end{equation}
		...
		\begin{equation*}
			...
			\end{cases}
		\end{equation*} 
		В случае, если $x_5(0)>0$ получим, что $\dot{x}_2(0)>0$, из чего $x_2(t)>0,\, t\in(0,\, \tilde{\varepsilon}_5),\,\tilde{\varepsilon}_5\leqslant\varepsilon_5$ и траектория не выходит из $D$ через плоскость $x_2=0$. При $x_5(0)=0$ и $t=0$, в свою очередь, система преобразуется к следующему виду:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1(0) &= r_1x_1(0)\left(1-\dfrac{x_1(0)}{c_1}\right)-\dfrac{\alpha_2x_3(0)}{x_4(0)+e_1}\dfrac{x_1(0)}{x_1(0)+k_1},\\
			...
			\end{cases}
		\end{equation*}  
		В случае, если $x_3(0)>0$ получим, что $\dot{x}_5(0)>0$, из чего $x_3(t)>0,\, t\in(0,\, \tilde{\varepsilon}^{\prime\prime}_5),\,\tilde{\varepsilon}^{\prime\prime}_5\leqslant\varepsilon_5$ и траектория не выходит из $D$ через плоскость $x_2=0$. При $x_3(0)=0$ система в начальный момент примет следующий вид:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
			...
			\end{cases}
		\end{equation*} 
		Здесь при $x_1(0)>0$ имеем, что $\dot{x}_3(0)>0$, то есть $x_3(t)>0,\, t\in(0,\, \tilde{\varepsilon}^{\prime\prime\prime}_5),\,\tilde{\varepsilon}^{\prime\prime\prime}_5\leqslant\varepsilon_5$. Из этого следует, что $x_2(t)>0,\, t\in(0,\, \tilde{\varepsilon}^{\prime\prime\prime}_5),\,\tilde{\varepsilon}^{\prime\prime\prime}_5\leqslant\varepsilon_5$ и траектория не выходит из $D$ через плоскость $x_2=0$. При $x_1(0)=0$ система в начальный момент примет следующий вид:
		\begin{equation*}
			\begin{cases}
				\begin{aligned}
					\dot{x}_1(0) &= 0,\\
	...
	\[P_1\left(0,0,\dfrac{s_1}{\mu_2},0\right),\, P_2\left(c_2,0,\dfrac{s_1}{\mu_2},0\right).\]
	...
	У преобразованной системы также два положения равновесия: $\left(0,\dfrac{s_1}{\mu_2}\right)$ и $\left(c_2,\dfrac{s_1}{\mu_2}\right)$.
	...
	У данной системы единственное положение равновесия --- $x_4=\dfrac{s_1}{\mu_2}$.
	
	\begin{theorem}
		Все компактные инвариантные множества системы (1) содержатся в положительно инвариантных множествах
		\begin{align*}
			K_1 &=\left\{0 \le x_1 \le \overline{x}_1 = c_1\right\}\cap D,\\
			K_2 &=\left\{\dfrac{s_1}{\mu_2} = \underline{x}_4 \le x_4 \le \overline{x}_4 = \dfrac{s_1}{\mu_2} + b_1c_1\right\}\cap K_1,\\
			K_3 &=\left\{0 \le x_3 \le \overline{x}_3 = \dfrac{a_2\overline{x}_1}{k_5+\underline{x}_4}\cdot\dfrac{\overline{x}_1+k_2}{\mu_1k_2}\right\}\cap K_2,\\
			K_4 &=\left\{0 \le x_5 \le \overline{x}_5 = \dfrac{b_3\overline{x}_3}{\mu_3}\right\}\cap K_3,\\
			K_5 &=\left\{0 \le x_2 \le \overline{x}_2 =  \dfrac{c_2}{2}+\sqrt{\dfrac{c_2^2}{4}+\dfrac{a_1\overline{x}_5}{k_4(\underline{x}_4+e_2)}}\right\}\cap K_4.
		\end{align*}
	\end{theorem}
	\begin{proof} 
		...
		\[\Omega(\varphi_2,\, K_1)=\left\{\underline{x}_4 \le x_4\leqslant \overline{x}_4\right\}\cap K_1=K_2.\]
		...
		\[\Omega(\varphi_3,\, K_2) = (\{0\leqslant x_3 \le \sup{x_3}\}\cap K_2) \subset (\{0 \le x_3\leqslant \overline x_3\} \cap K_2) = K_3.\]
		...
		\[\Omega(\varphi_5,\, K_4)=\{0\leqslant x_2 \le \overline{x}_2\} \cap K_4 = K_5.\qed\]
	\end{proof}
	...
	\begin{proof}
		...
		\[K_1(\tau_1) = \{0 \le x_1 \le c_1+\tau_1\}\cap D,\, \tau_1\geqslant0.\]
		...
		Рассмотрим множество 
		\[K_2(\tau_1,\,\tau_2,\, \tilde{\tau}_2)=\left\{\dfrac{s_1}{\mu_2}-\tilde{\tau}_2 \le x_4 \le \dfrac{s_1}{\mu_2} + \dfrac{b_1\overline{\xi}_1(\tau_1)}{\mu_2} + \tau_2\right\}\cap K_1(\tau_1),\,\tau_1,\,\tau_2,\,\tilde{\tau}_2 \geqslant 0.\]   
		...
		Пусть 
		\[K_3(\tau_1,\,\tau_2,\, \tilde{\tau}_2,\,\tau_3) = \left\{0 \le x_3 \le \dfrac{a_2\overline{\xi}_1(\tau_1)}{k_5+\underline{\xi}_4(\tilde{\tau}_2)}\cdot\dfrac{\overline{\xi}_1(\tau_1)+k_3}{\mu_1k_3}+\tau_3\right\}\cap K_2(\tau_1,\, \tau_2,\, \tilde{\tau}_2),\]
		где $\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3 \geqslant 0$. Тогда на множестве 
		\[K_2(\tau_1,\, \tilde{\tau}_2,\, \tau_2)\setminus K_3(\tau_1,\,\tau_2,\, \tilde{\tau}_2,\, \tau_3)=\left\{x_3 > \dfrac{a_2\overline{\xi}_1(\tau_1)}{k_5+\underline{\xi}_4(\tilde{\tau}_2)}\cdot\dfrac{\overline{\xi}_1(\tau_1)+k_3}{\mu_1k_3}+\tau_3\right\}\cap K_2(\tau_1,\, \tau_2,\, \tilde{\tau}_2)\]
		справедливо, что
		\begin{multline*}
		...
		Положим, что 
		\[K_4(\tau_1,\,\tau_2,\, \tilde{\tau}_2,\, \tau_3,\,\tau_4) = \left\{0 \le x_5 \le \dfrac{b_2\overline{\xi}_3(\tau_1,\,\tau_2,\, \tilde{\tau}_2,\, \tau_3)}{\mu_3}+\tau_4\right\}\cap K_3(\tau_1,\,\tau_2,\, \tilde{\tau}_2,\, \tau_3),\]
		...
		Рассмотрим множество 
		\begin{multline*}
			K_5(\tau_1,\,\tau_2,\,\tilde{\tau}_2,\,\tau_3,\,\tau_4,\,\tau_5) = \biggr\{0 \le x_2 \le \dfrac{c_2}{2}+\\
	...
	\begin{theorem}
		Система \ref{eq:initial_system} на границе области $D$ при положительных значениях параметров имеет положения равновесия $P_1\left(0,0,0,\dfrac{s_1}{\mu_2},0\right)$ и $P_2\left(0,c_2,0,\dfrac{s_1}{\mu_2},0\right)$. 
	\end{theorem}
	...
	\begin{proof}
		...
		\[\begin{pmatrix}
			r_{1} & 0 & 0 & 0 & 0\\ 
			0 & r_{2} & 0 & 0 & \dfrac{a_{1}}{k_{4}\,\left(e_{2}+\dfrac{s_{1}}{\mu _{2}}\right)}\\ 
			\dfrac{a_{2}}{k_{5}+\dfrac{s_{1}}{\mu _{2}}} & 0 & -\mu _{1} & 0 & 0\\ 
			b_{1} & 0 & 0 & -\mu _{2} & 0\\ 
			0 & 0 & b_{2} & 0 & -\mu _{3} 
		\end{pmatrix}\]
		...
		\[\begin{pmatrix}
			r_{1}-\dfrac{\alpha _{1}\,c_{2}}{k_{1}\,\left(e_{1}+\dfrac{s_{1}}{\mu _{2}}\right)} & 0 & 0 & 0 & 0\\ 
			-\dfrac{\alpha _{3}\,c_{2}}{k_{2}} & -r_{2} & 0 & 0 & \dfrac{a_{1}}{k_{4}\,\left(e_{2}+\dfrac{s_{1}}{\mu _{2}}\right)}\\ 
			\dfrac{a_{2}}{k_{5}+\dfrac{s_{1}}{\mu _{2}}} & 0 & -\mu _{1} & 0 & 0\\ 
			b_{1} & 0 & 0 & -\mu _{2} & 0\\ 
			0 & 0 & b_{2} & 0 & -\mu _{3}
		\end{pmatrix}\]
	...
	\begin{thebibliography}{19}
		...
		Zeng T, Cui D, Gao L. Glioma: an overview of current classifications, characteristics, molecular biology and target therapies. Front Biosci (Landmark Ed). 2015 Jun 1;20(7):pp.1104-15. doi: 10.2741/4362. PMID: 25961548.
		\bibitem{abt_DEs}
		S. Bunimovich-Mendrazitsky, J. C. Gluckman and J. Chaskalovic, J. Theor. Biol. 277,27 (2011).
		\bibitem{Kasbawati et.al.}
		Kasbawati, Yuliana Jao, Nur Erawaty. Dynamic study of the pathogen-immune system interaction with natural delaying effects and protein therapy[J]. AIMS Mathematics, 2022, 7(5): pp.7471-7488. doi: 10.3934/math.2022419
		\bibitem{W. L. Duan et.al.}
		W. L. Duan, H. Fang, C. Zeng, The stability analysis of tumor-immune responses to chemotherapy system with gaussian white noises. Chaos, Soliton. Fract., 127 (2019), pp.96–102. https://doi.org/10.1016/j.chaos.2019.06.030. doi: 10.1016/j.chaos.2019.06.030 
		...
		dePillis, L.G., Eladdadi, A. \& Radunskaya, A.E. Modeling cancer-immune responses to therapy. J Pharmacokinet Pharmacodyn 41, pp.461–478 (2014). https://doi.org/10.1007/s10928-014-9386-9
		\bibitem{F. A. Rihan et.al.}
		F. A. Rihan, D. H. A. Rahman, Delay differential model for tumour-immune dynamics with HIV infection of CD4+ T-cells, Int. J. Comput. Math., 90 (2013), pp.594–614, http://dx.doi.org/10.1080/00207160.2012.726354. doi: 10.1080/00207160.2012.726354 
		...
		Chakrabarty SP, Hanson FB. Distributed parameters deterministic model for treatment of brain tumors using Galerkin finite element method. Math Biosci. 2009; 219(2): pp.129–141. pmid:19345698
		\bibitem{Bandera}
		Bandara S, Diehl M, Fricker G. A mathematical model for the transport of paclitaxel (Taxol) across the blood-brain barrier. Chem Eng Res Des. 2007; 85: pp.1065–1071.
		\bibitem{Kirkby et.al.}
		Kirkby NF, Jefferies SJ, Jena R, Burnet NG. A mathematical model of the treatment and survival of patients with high-grade brain tumours. J Theor Biol. 2007; 245: pp.112–124. pmid:17084863
		\bibitem{Schmitz et.al.}
		Schmitz JE, Kansal AR, Torquato S. A cellular automaton model of brain tumor treatment and resistance. J Theor Med. 2002; 4(4): pp.223–239.
		\bibitem{Walker et.al.}
		Walker WL, Cook J. Drug delivery to brain tumors. Bull Math Biol. 1996; 58(6): pp.1047–1074. pmid:8953256
		\bibitem{Kronik et.al.}
		Kronik N, Kogan Y, Vainstein V, Agur Z. Improving alloreactive CTL immunotherapy for malignant gliomas using a simulation model of their interactive dynamics. Cancer Immunol Immunother. 2008; 57: pp.425–439. pmid:17823798
		\bibitem{model}
