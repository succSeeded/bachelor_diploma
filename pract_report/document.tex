...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{proof} 
		...
		\begin{multline*}
		r_2x_2\left(1-\dfrac{x_2}{c_2}\right)+\dfrac{x_5}{k_4+x_5}a_1\dfrac{1}{x_4+e_2}-\alpha_3\dfrac{x_1x_2}{x_1+k_2}\leqslant\\
		\leqslant r_2x_2\left(1-\dfrac{x_2}{c_2}\right)+\dfrac{a_1\overline{x}_5}{(\overline{x}_5+k_4)(\underline{x}_4+e_2)}.
		\end{multline*}
		Т.е.
	...
	\begin{proof}
		...
		\[\begin{pmatrix}
			r_{1} & 0 & 0 & 0 & 0\\ 
			0 & r_{2} & 0 & 0 & \dfrac{a_{1}}{k_{4}\,\left(e_{2}+\dfrac{s_{1}}{\mu _{2}}\right)}\\[6pt] 
			\dfrac{a_{2}}{k_{5}+\dfrac{s_{1}}{\mu _{2}}} & 0 & -\mu _{1} & 0 & 0\\[6pt] 
			b_{1} & 0 & 0 & -\mu _{2} & 0\\ 
			0 & 0 & b_{2} & 0 & -\mu _{3} 
		\end{pmatrix}.\]
		...
		\[\begin{pmatrix}
			r_{1}-\dfrac{\alpha _{1}\,c_{2}}{k_{1}\,\left(e_{1}+\dfrac{s_{1}}{\mu _{2}}\right)} & 0 & 0 & 0 & 0\\[35pt]
